...
tuic5_link="tuic://$uuid:$uuid@$sb_tu5_ip:$tu5_port?congestion_control=bbr&udp_relay_mode=native&alpn=h3&sni=$tu5_name&pinnedPeerCertSha256=$TU5_SHA256#tu5-$hostname"
else
...
curl -sL https://raw.githubusercontent.com/heartreeW/sing-box-yg-ultra/main/version | awk -F "更新内容" '{print $1}' | head -n 1 > /etc/s-box/v
red "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
lnsb(){
rm -rf /usr/bin/sb
curl -L -o /usr/bin/sb -# --retry 2 --insecure https://raw.githubusercontent.com/heartreeW/sing-box-yg-ultra/main/sb.sh
chmod +x /usr/bin/sb
}
...
service iptables save >/dev/null 2>&1
green "Sing-box卸载完成！"
blue "欢迎继续使用Sing-box-yg脚本：bash <(curl -Ls https://raw.githubusercontent.com/heartreeW/sing-box-yg-ultra/main/sb.sh)"
echo
}
...
latestV=$(curl -sL https://raw.githubusercontent.com/heartreeW/sing-box-yg-ultra/main/version | awk -F "更新内容" '{print $1}' | head -n 1)
...
echo -e "${yellow}$(curl -sL https://raw.githubusercontent.com/heartreeW/sing-box-yg-ultra/main/version)${plain}"
fi
else
